		...
		<tbody>
			...
			<tr>
				...
				<shiro:hasRole name="SchoolAssistant">
					<td><g:if test="${socialGroupBean.cBullying > 0}"><i class="icon-comment-alt"></i> (${socialGroupBean.cBullying})</g:if></td>
					<td><g:if test="${socialGroupBean.cSurveys > 0}"><i class="icon-check"></i> (${socialGroupBean.cSurveys})</g:if></td>
					<td><g:if test="${socialGroupBean.cSociogram > 0}"><i class="icon-retweet"></i> (${socialGroupBean.cSociogram})</g:if></td>				
				</shiro:hasRole>					
				<td class="link">
