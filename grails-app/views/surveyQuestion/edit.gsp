...
<html>
	<head>
		...
		<title><g:message code="survey.question.edit.header" default="Edit Survey Question" /></title>
	</head>
	...
	<body>
		...
		<div class="span9">
			...
			<div class="page-header">
				<h1>
					<i class="icon-check"></i>  <g:message code="survey.question.edit.header" default="Edit Survey Question"/>
			...
			<fieldset>
				<g:form action="update" method="post" class="form-horizontal">
					...
					<tb:controlGroup name="description"
						...
						<g:field type="text" name="description" id="description" class="input-xxlarge" required="" value="${surveyQuestion.description}" autocomplete='off'/>
					</tb:controlGroup>
