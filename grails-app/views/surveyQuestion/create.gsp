...
<html>
	<head>
		...
		<title><g:message code="survey.question.create.header" default="Create Survey Question" /></title>
	</head>
	...
	<body>
		...
		<div class="span9">
			...
			<div class="page-header">
				<h1>
					<i class="icon-check"></i>  <g:message code="survey.question.create.header" default="Create Survey Question"/>
			...
			<g:hasErrors bean="${survey}">
				<div class="alert alert-block alert-error">
					<a class="close" data-dismiss="alert">&times;</a>
					<ul>
						<g:eachError bean="${survey}" var="error">
			...
			<fieldset>
				<g:form action="save" method="post" class="form-horizontal">
					...
					<g:hiddenField name="survey" value="${survey.id}" />
					...
					<div class="form-actions">
						...
						<a href="${createLink(uri: "/surveyQuestion/list")}/${survey.id}" class="btn">
