			...
			<div class="span4">
				...
				<script language="JavaScript">
					 ...
					 function openNewWindow() {
						 //popupWin = window.open('/rs-peacemakers/student', //Desarrollo
						 popupWin = window.open($('#restURI').val() + 'student',
						 'open_window',
						 'left=0, top=0, fullscreen=yes, location=no, menubar=no, scrollbars=yes, status=yes, titlebar=yes, toolbar=no')
					 }
					 // done hiding -->
				 </script>
