...
<html>
	<head>
		...
		<title><g:message code="survey.edit.header" default="Edit Survey" /></title>
	</head>
	...
	<body>
		...
		<div class="span9">
			...
			<div class="page-header">
				<h1>
					<i class="icon-check"></i>  <g:message code="survey.edit.header" default="Edit Survey"/>
				</h1>
			</div> <!-- page-header -->
			<p></p>
			...
			<fieldset>
				<g:form action="update" method="post" class="form-horizontal">
					...
					<tb:controlGroup name="name"
						...
						<g:field type="text" name="name" id="name" class="input-xxlarge" required="" value="${surveyBean.name}" autocomplete='off'/>
					</tb:controlGroup>
