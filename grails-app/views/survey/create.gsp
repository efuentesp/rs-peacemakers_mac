...
<html>
	<head>
		...
		<title><g:message code="survey.create.header" default="Create Survey" /></title>
	</head>
	...
	<body>
		...
		<div class="span9">
			...
			<div class="page-header">
				<h1>
					<i class="icon-check"></i>  <g:message code="survey.create.header" default="Create Survey"/>
				</h1>
			</div> <!-- page-header -->
			<p></p>
			...
			<fieldset>
				<g:form action="save" method="post" class="form-horizontal">
					...
					<tb:controlGroup name="name"
						...
						<g:field type="text" name="name" id="name" class="input-xxlarge" required="" value="" autocomplete='off'/>
					</tb:controlGroup>
